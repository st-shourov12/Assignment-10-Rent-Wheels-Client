...
const LatestCars = ({latestCarsPromise}) => {
    ...
    // ({cars.length})
    return (
        <div className='bg-[#E2E8F0] dark:bg-gray-800 p-5 sm:p-10 md:p-16'>
            ...
            <div className={`grid md:grid-cols-2 xl:grid-cols-3 justify-between ${cars.length > 6 && '2xl:grid-cols-4'} gap-10 px-2 `}>
                {
                    cars.map(car =>(
