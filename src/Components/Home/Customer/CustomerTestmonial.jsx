...
const CustomerTestmonial = () => {
    return (
        <div className='p-10 md:p-16 dark:bg-gray-700'>
            <h2 className="text-2xl lg:text-4xl font-bold text-[#0F172A] dark:text-white text-center">
            
               <span className="text-[#DC2626]">Customer </span>Testimonials
            </h2>
            <p className="text-gray-700 dark:text-white/75 md:text-lg font-medium text-center my-5">
            ...
            <div className="flex w-[80vw]  mx-auto flex-col lg:flex-row justify-between items-center gap-5">
                <div className="p-5 bg-white h-full dark:bg-gray-900  max-w-[400px] rounded-xl gap-3 shadow-md hover:shadow-lg transition duration-300 flex flex-col justify-between items-center">
                    <figure>
                    ...
                    <p className='text-lg italic text-gray-700 dark:text-white/75'>
                ...
                <div className="p-5 bg-white dark:bg-gray-900 max-w-[400px] rounded-xl gap-3 shadow-md hover:shadow-lg transition duration-300 flex flex-col justify-between items-center">
                    <figure>
